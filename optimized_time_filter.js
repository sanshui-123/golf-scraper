    ...
    getWebsiteSpecificWindow(domain) {
        const websiteConfig = {
            'golf.com': { 
                normal: 12, 
                highFreq: 6, 
                reason: 'Golf.com适度放宽时间窗口' 
            },
            'golfmonthly.com': { 
                normal: 48, 
                highFreq: 24, 
                reason: 'Golf Monthly更新较慢，需要更大窗口确保不遗漏' 
            },
            'mygolfspy.com': { 
                normal: 24, 
                highFreq: 12, 
                reason: 'MyGolfSpy装备评测周期较长' 
            },
            'golfwrx.com': { 
                normal: 12, 
                highFreq: 6, 
                reason: 'GolfWRX论坛型网站适度窗口' 
            },
            'golfdigest.com': { 
                normal: 24, 
                highFreq: 12, 
                reason: 'Golf Digest专业内容更新周期较长' 
            },
            'todays-golfer.com': { 
                normal: 24, 
                highFreq: 12, 
                reason: "Today's Golfer内容更新周期较长" 
            }
        };
    ...
    generateTimeFilterReport() {
        ...
        const report = {
            ...
            websiteRecommendations: {
                ...
                'todays-golfer.com': this.getWebsiteSpecificWindow('todays-golfer.com')
            }
        };
